...
namespace EVEBox.JieMian
{
    ...
    public partial class YouMianBanBuilder
    {
        ...
        // 用户备注相关事件
        public event EventHandler<YongHuBeiZhuBianJiCanShu> UserRemarkEdited;

        public YouMianBanBuilder()
        {
    ...
    /// 用户备注编辑事件参数
    /// </summary>
    public class YongHuBeiZhuBianJiCanShu : EventArgs
    {
        public string UserId { get; }
        public string Remark { get; }

        public YongHuBeiZhuBianJiCanShu(string userId, string remark)
        {
            UserId = userId;
            Remark = remark;
        }
