...
namespace EVEBox.Common.GongYong
{
    ...
    /// 同步进度对话框
    /// </summary>
    public partial class TongBuJinDuDialog : JiChuDialog
    {
        ...
        public TongBuJinDuDialog(string title = "同步进度", int totalSteps = 100)
        {
        ...
        {
            using var dialog = new TongBuJinDuDialog(title);
            dialog.Show(owner);
            Application.DoEvents();
