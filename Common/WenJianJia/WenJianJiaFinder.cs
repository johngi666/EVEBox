...
namespace EVEBox.Common.WenJianJia
{
    ...
    public class WenJianJiaFinder
    {
        ...
        public WenJianJiaFinder(Dictionary<string, string> serverKeywords, Action<string, string, string> logAction, Action<string> onFolderFound)
        {
