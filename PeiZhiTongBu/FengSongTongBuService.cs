...
namespace EVEBox.PeiZhiTongBu
{
    ...
    /// 统一对外入口，整合读取、解析、编码功能
    /// </summary>
    public class FengSongTongBuService
    {
        private readonly FengSongReader _reader;
        private readonly FengSongParser _parser;

        public FengSongTongBuService()
        {
            _reader = new FengSongReader();
            _parser = new FengSongParser();
        }

        /// <summary>
        /// 读取 .dat 文件，返回完整的 Marshal 数据对象
        /// </summary>
        public FengSongShuJu ReadDatFile(string datPath)
        {
        ...
        /// </summary>
        public YongHuZiDuanYingShe LoadUserMappingsFromDat(string datPath)
        {
        ...
        /// 从 JSON 字符串加载用户字段映射
        /// </summary>
        public YongHuZiDuanYingShe LoadUserMappingsFromJson(string jsonString)
        {
