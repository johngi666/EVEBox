...
{
    public partial class BanBenGuanLiDialog : JiChuDialog
    {
        // 恢复原风格：标题居中、深蓝标题栏（日间）
        ...
        public BanBenGuanLiDialog(string parentFolder, Action<string> addLogCallback)
        {
        ...
        {
            // 日间用深蓝标题栏，夜间用主题色
            TitleBar.BackColor = ZhuTiManager.IsDarkMode
                ? ZhuTiManager.TitleBar
