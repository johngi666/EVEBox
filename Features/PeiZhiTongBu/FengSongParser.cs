...
namespace EVEBox.Features.PeiZhiTongBu
{
    ...
    public class FengSongParser
    {
        ...
        /// 批量提取所有映射数据
        /// </summary>
        public FengSongShuJu ExtractAll(JsonDocument jsonDocument)
        {
            return new FengSongShuJu
            {
        ...
        /// 从 JSON 字符串中提取所有映射数据
        /// </summary>
        public FengSongShuJu ExtractAllFromString(string jsonString)
        {
